...
| **every reading, and its rule** | the organiser measures "portfolio's total equity as of EOD Thursday Sep 3rd", which the broker stamps at **$102,588.74**. The account read $102,061.24 at 23:57 UTC that evening, before the stamp. lablab measures again at Friday 15:00 UTC. And the account goes on trading, so the live figure moves. `docs/write-up.md` sets out all four with the rule behind each |
