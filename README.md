...
| **the rule this is measured by** | the organiser: "evaluation based on portfolio's total equity as of EOD Thursday Sep 3rd". The broker's record of that close is $102,588.74. lablab measures again at Friday 15:00 UTC, and the account goes on trading after both. All four readings and the rule behind each are in `docs/write-up.md` |
